...
<head>
    ...
    <title>Hệ thống quản lý thư viện trực tuyến | Chỉnh sửa sách</title>
...
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Chọn hình ảnh</a>
</div></div>
...
<p class="help-block">ISBN là mã số sách chuẩn quốc tế. ISBN phải là duy nhất !</p>
</div></div>
...
<button type="submit" name="update" class="btn btn-info">Cập nhật</button></div>
