...
<head>
    ...
    <title>Hệ thống quản lý thư viện trực tuyến | Quản lý tác giả</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="manage-authors.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có chắc chắn muốn xóa không?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Xoá</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
