...
<head>
    ...
    <title>Hệ thống quản lý thư viện trực tuyến | Quản lý sách</title>
...
<img src="bookimg/<?php echo htmlentities($result->bookImage);?>" width="100">
                                          ...
                                          <a href="manage-books.php?del=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có chắc chắn muốn xóa không?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Xoá</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
