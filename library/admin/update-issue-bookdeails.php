...
<head>
    ...
    <title>Hệ thống quản lý thư viện trực tuyến | Chi tiết sách đã phát hành</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">THÔNG TIN MƯỢN / TRẢ SÁCH</h4>
...
<div class="col-md-12"> 
<div class="form-group">
<label>Phạt(do làm hư , hỏng) :</label>
<?php 
if($result->fine=="")
{?>
