...
<div class="col-md-12">
<h4 class="header-line">ĐĂNG NHẬP NGƯỜI DÙNG</h4>
</div>
</div>
 <a name="ulogin"></a>            
<!--LOGIN PANEL START-->           
...
<label>Tên đăng nhâp(Địa chỉ Email)</label>
...
<p class="help-block"><a href="user-forgot-password.php">Quên mật khẩu</a></p>
 ...
 <button type="submit" name="login" class="btn btn-info">Đăng nhập </button> | <a href="signup.php">Đăng ký</a>
</form>
 </div>
</div>
</div>
