...
<head>
    ...
    <title>Hệ thống quản lý thư viện trực tuyến | Khôi phục mật khẩu </title>
...
<input class="form-control" type="password" name="confirmpassword" required autocomplete="off"  />
 ...
 <button type="submit" name="change" class="btn btn-info">Lưu</button> | <a href="index.php">Đăng nhập</a>
</form>
 </div>
</div>
</div>
